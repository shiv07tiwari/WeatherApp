...
public class WeatherProvider extends ContentProvider {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case WEATHER: {
                retCursor = mOpenHelper.getReadableDatabase().query(
                        WeatherContract.WeatherEntry.TABLE_NAME,  //URI
                        projection,  // Set to return null if all
            ...
            case LOCATION: {
             // normalizeDate(values);
              ...
              if(_id>0)
                  ...
                  throw new android.database.SQLException("Failed to insert row intoL"+uri);
              break;
            }
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
    ...
    // A faster way to insert a bulk of data in a weather table !
    @Override
