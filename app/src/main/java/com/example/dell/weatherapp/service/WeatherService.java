...
public class WeatherService extends IntentService {
    ...
    final String LOG_TAG = WeatherService.class.getSimpleName();
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        try {
            ...
            final String api= "43193720a7c1e6dae3e4d3f874e659bc";
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APP_ID_PARAM,api)
                    .build();

            URL url = new URL(builtUri.toString());
            Log.e(LOG_TAG,"build url : "+url);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                Log.e(LOG_TAG,"City name : "+cityName );
                Log.e(LOG_TAG,"City Temp max : "+high );
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor locationCursor = this.getContentResolver().query(
                ...
                null);  //We perform a basic query which returns the location cursor.

        if (locationCursor.moveToFirst()) {   //we check if this exists in the db, if yes, return the id.
            ...
            Uri insertedUri = this.getContentResolver().insert(
                    WeatherContract.LocationEntry.CONTENT_URI,
                    locationValues
            );   //As the insert function returns an uRI
            // The resulting URI contains the ID for the row.  Extract the locationId from the Uri.
            locationId = ContentUris.parseId(insertedUri);
        }
        locationCursor.close(); // always close the cursors !!
        return locationId;
    }
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Toast.makeText(context, "Alarm Fired",
